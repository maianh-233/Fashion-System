...
import { brandApi } from "../../../api/catalogApi";
...
const fields = [{ key: "name", label: "Tên", required: true, fullWidth: true }, { key: "code", label: "Mã", generated: true }, { key: "logo", label: "Logo", type: "image" }, { key: "description", label: "Mô tả", type: "textarea" }];
